    ...
    return (
        <div>
            ...
            <form className="mt-10 space-y-4">
                ...
                <button className='capitalize font-medium bg-indigo-700 text-white text-[15px] py-2 rounded-lg w-full hover:translate-x-2 transition-all'>Register</button>
                <p className='text-center font-medium'>Don{"'"}t Have An Account <span onClick={() => setShowReg(false)} className="underline text-indigo-600 cursor-pointer">Login</span></p>
            </form>
        </div>
    );
};
